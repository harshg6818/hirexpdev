  ...
  <div class="">
    <v-layout row wrap>
      <v-flex sm12 px-1>
        ...
        <v-layout row wrap class="pb-4 white">
          ...
          <div class="w-100" v-show="!config.initialLoading && questions && questions.length > 0">
            ...
            <v-layout v-for="(q, qi) in questions" :key="qi" class="active-response py-2" style="border-bottom:1px solid rgb(243, 241, 241);background-color:#fff">
              <!--<v-card class="w-100 mb-4 pa-3 elevation-0 d-inline-flex">
                <v-layout>-->
                  <v-flex xs1>
                    <p class="pt-0 px-3 text-xs-center" style="border-radius:0px"> Q {{ qi+1 }} </p>
                  </v-flex>
                  <v-flex xs8>
