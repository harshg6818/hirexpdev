    ...
    <div class="mt-2 px-4">
      ...
      <v-layout row wrap class="b-top" style="border-color: #f3f1f1">
        ...
        <v-flex xs1 text-xs-center>
          <v-icon large color="#06adaa" class="pt-4"> fa fa-check-circle </v-icon>
        </v-flex>
        <v-flex xs6>
      ...
      <v-layout class="b-top" style="border-color: #f3f1f1">
        ...
        <v-flex xs1 text-xs-center>
          <!--<v-icon color="#06adaa" class="text--white" class="pt-4"> fa fa-check-circle </v-icon>-->
        </v-flex>
        <v-flex xs6>
